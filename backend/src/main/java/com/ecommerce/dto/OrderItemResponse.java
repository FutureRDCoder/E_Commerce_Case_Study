...
public class OrderItemResponse {
    ...
    public OrderItemResponse(Long id, Long productId, String productName, String productCategory, Integer quantity, Double unitPrice, Double subtotal, String productImageUrl) {
        this.id = id;
